      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <div className="flex items-center space-x-3 mb-4">
              ...
              <span className="font-bold text-xl">YŌVO HUB</span>
            </div>
            <p className="text-gray-300 mb-6 max-w-md">
              Transformer l'engagement en compétences concrètes et en revenus. 
              Connectez-vous avec des micro-projets et des missions à impact local.
            </p>
          ...
          <div>
            ...
            <div className="space-y-3">
              <div className="flex items-center space-x-3">
                ...
                <span className="text-gray-300">bonjour@yovohub.tg</span>
              </div>
              <div className="flex items-center space-x-3">
        ...
        <div className="border-t border-gray-800 pt-8 mt-8 text-center">
          <p className="text-gray-400">
            © 2025 YŌVO HUB. Tous droits réservés. | 
            <Link to="/privacy" className="hover:text-white transition-colors ml-1">
              Politique de confidentialité
            </Link> | 
            <Link to="/terms" className="hover:text-white transition-colors ml-1">
